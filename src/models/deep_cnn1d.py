"""
===============================================================================
Script Name   : deep_cnn1d.py
Description   : Defines the 1D Convolutional Neural Network (CNN-1D) architecture.
                Purpose:
                - To capture local correlations between adjacent flow features.
                - Serves as a structurally different architecture to test adversarial transferability
                  (i.e., do attacks crafted on an MLP transfer to a CNN?).
                
                Architecture:
                - 1D Convolutional layers -> ReLU -> Batch Normalization.
                - Global Average Pooling or Flattening before the final classification head.
